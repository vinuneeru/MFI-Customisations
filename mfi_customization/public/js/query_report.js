...
frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
	...
	add_prepared_report_buttons(doc) {
		if (doc) {
            ...
            if (doc.report_name=="Purchase Request Template"){
                this.page.add_inner_button(__("Create Material Request"), function (){
                    frappe.model.open_mapped_doc({
						method: "mfi_customization.mfi.doctype.material_request.make_material_req",
						source_name: {
	...
	prepare_columns(columns) {
		return columns.map(column => {
			...
			return Object.assign(column, {
				...
				editable: column.editable==undefined?false:true,
